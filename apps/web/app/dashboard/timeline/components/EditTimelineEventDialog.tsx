...
interface EditTimelineEventDialogProps {
  ...
  onCloseAction: () => void;
  onSubmitAction: (eventId: string, data: Partial<TimelineEvent>) => void;
  loading?: boolean;
}
        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
          ...
          >
            ...
            <Typography
              ...
              sx={{ color: "rgba(255, 255, 255, 0.8)" }}
            >
              Tạo bởi: {event.user.displayName}
            </Typography>
            <Typography
              variant="body2"
              sx={{ color: "rgba(255, 255, 255, 0.8)" }}
            >
              Tạo lúc: {event.createdAt.toLocaleString('vi-VN')}
            </Typography>
          </Box>
          ...
          {/* Associated Project/Task Info */}
          {(event.project || event.task) && (
            <Box
              sx={{
                p: 2,
                backgroundColor: "rgba(255, 255, 255, 0.05)",
